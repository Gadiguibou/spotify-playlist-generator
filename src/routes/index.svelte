<script lang="ts">
    ...
    import { accessTokenStore, refreshAccessToken } from "$lib/apiUtilities/authorization";
    import {
        getUsersPlaylists,
        getPlaylistItems,
        searchPlaylists,
    ...
    import { getMinimalSizeImageUrl } from "$lib/generalUtilities";

    let accessToken = $accessTokenStore;
    let userPlaylists = [];
    onMount(async () => {
        if (!accessToken) {
            ...
            <ul class="container">
                {#each randomTrackSelection as track}
                    <li class="random-selection-entry">
                        <p>{track.name}</p>
                        <button on:click={() => (blacklistedTracks = [...blacklistedTracks, track])}
                            ><img
        ...
        <div class="container">
            ...
            <form>
                ...
                <div class="container">
                    ...
                    <textarea id="new-playlist-description" bind:value={newPlaylist.description} />
                </div>
                <div class="container">
